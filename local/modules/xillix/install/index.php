    ...
    public function InstallDB()
    {
        ...
        if ($result->isSuccess()) {
            ...
            $fields = [
                ...
                [
                    'ENTITY_ID' => 'HLBLOCK_' . $hlblockId,
                    'FIELD_NAME' => 'UF_SCHEDULED_LESSON',
                    'USER_TYPE_ID' => 'string',
                    'XML_ID' => 'UF_SCHEDULED_LESSON',
                    'SORT' => 900,
                    'MULTIPLE' => 'N',
                    'MANDATORY' => 'N',
                    'SHOW_FILTER' => 'I',
                    ...
                    'EDIT_IN_LIST' => 'Y',
                    'IS_SEARCHABLE' => 'N',
                    'EDIT_FORM_LABEL' => ['ru' => 'Запланированный урок (TrueConf)'],
                    'LIST_COLUMN_LABEL' => ['ru' => 'Конференция'],
                    'SETTINGS' => ['SIZE' => 60],
                ],
                [
                    'ENTITY_ID' => 'HLBLOCK_' . $hlblockId,
                    'FIELD_NAME' => 'UF_VIDEO_LESSON_LINK',
                    'USER_TYPE_ID' => 'string',
                    'XML_ID' => 'UF_VIDEO_LESSON_LINK',
                    'SORT' => 950,
                    'MULTIPLE' => 'N',
                    'MANDATORY' => 'N',
                    'SHOW_FILTER' => 'I',
                    ...
                    'EDIT_IN_LIST' => 'Y',
                    'IS_SEARCHABLE' => 'N',
                    'EDIT_FORM_LABEL' => ['ru' => 'Ссылка на видео урока'],
